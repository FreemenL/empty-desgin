...
const EsearchListHocDome = connectAid([
  LOGIN,
  DATALIST,
  DUTY_DATALIST_DELETE,
  DUTY_DATALIST_UPDATE,
  DUTY_DATALIST_ADD,
])(
  EsearchListHoc({
    header: '数据展示',
    ...
    headMenu: [
      function(this: any, callback) {
        return (
          <span
            className={`${styles['head-menu-add']}`}
            onClick={() => this.props.method.handleListAdd(callback)}
          />
        );
      },
    ],
    ...
    method: {
      ...
      componentDidMount(params = {}, props /*,currentState*/) {
        ...
        props.Actions[Actions['DATALIST_action']](DATALIST + '_REQUEST', {
          ...effectParams,
          ...params,
        });
      },
