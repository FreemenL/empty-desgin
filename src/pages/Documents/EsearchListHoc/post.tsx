    ...
    searchPanel: {
      search: [
        ...
        },
        {
          ...
          antdOptions: {
            initialValue:
              that && that.params ? moment(that.params.onRange.split('-')[0], format) : moment(),
            rules: [
              {
                required: true,
                message: '请输入时间',
        ...
        },
        {
          ...
          antdOptions: {
            initialValue:
              that && that.params ? moment(that.params.onRange.split('-')[1], format) : moment(),
            rules: [
              {
                required: true,
                message: '请输入时间',
        ...
        },
        {
          ...
          antdOptions: {
            initialValue:
              that && that.params ? moment(that.params.offRange.split('-')[0], format) : moment(),
            rules: [
              {
                required: true,
                message: '请输入时间',
        ...
        },
        {
          ...
          antdOptions: {
            initialValue:
              that && that.params ? moment(that.params.offRange.split('-')[1], format) : moment(),
            rules: [
              {
                required: true,
                message: '请输入时间',
