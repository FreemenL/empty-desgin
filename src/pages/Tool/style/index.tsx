    ...
    return (
      <>
        ...
        <p className="empty-line-content e-flex-col">
          <span style={this._addStyle} className="e-bg-blue">
            {' '}
            e-bg-blue
          </span>
          <span style={this._addStyle} className="e-bg-light-blue">
            {' '}
            e-bg-light-blue
          </span>
          <span style={this._addStyle} className="e-bg-green">
            {' '}
            e-bg-green{' '}
          </span>
          <span style={this._addStyle} className="e-bg-yellow">
            {' '}
            e-bg-yellow{' '}
          </span>
          <span style={this._addStyle} className="e-bg-red">
            {' '}
            e-bg-red
          </span>
          <span style={this._addStyle} className="e-bg-block">
            {' '}
            e-bg-block
          </span>
        </p>
