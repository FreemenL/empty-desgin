...
const webpackDllConfig = {
  ...
  entry: {
    //动态链接库
    [`${systemConfig.systemPath.appdllLibrary}_${process.env.NODE_ENV.substring(0,3)}`]:Object.keys(package.dependencies).filter((dependency)=>!systemConfig.dllLibraryExclude.includes(dependency))
  },
  output: {
