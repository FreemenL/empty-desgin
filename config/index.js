module.exports = {
  ...
  systemPath: {
    ...
    appTsLoader: ['node_modules/_emptyd@0.1.5@emptyd','node_modules/_free-validator@1.0.7@free-validator', 'node_modules/_freetool@0.0.3@freetool'],
  ...
  // 动态连接库中排除
  dllLibraryExclude: ['emptyd','free-validator','freetool','antd', 'normalize.css','animate.css'],
  // 是否开启编译缓存 
